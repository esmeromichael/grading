    ...
    <div id="wrapper_all">
        <nav id="side_fixed_nav">
            <ul id="text_nav_side_fixed">
               <li>
                    <a class="dropdown-toggle" href="#" data-toggle="modal" data-target=""><span class="fa fa-group fa-3x"></span> Deskpad</a>

                </li>
                <li>
                    <a class="dropdown-toggle" href="#" data-toggle="modal" data-target=""><span class="fa fa-cog fa-3x"></span> Operations</a>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#" data-toggle="modal" data-target=""><span class="fa fa-bar-chart fa-3x"></span> Accounting</a>
                </li>
                <li>
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-2">
                        <a href="/" class="logo_main" title="MTO Technotrends">
                            <img src="/images/grade_main.png" style="width:50px; height:50px;" alt="MTO Technotrends">
                        </a>
                    </div>
