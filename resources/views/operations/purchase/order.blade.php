...
<section class="container main_section">
    <nav id="top_navigation" class="text_nav">
        <div class="container">
            <ul id="text_nav_h" class="clearfix j_menu top_text_nav jMenu">
                ...
                <li class="active"><a href="/operations/purchase/order">Order</a></li>
    ...
    <h5>This is the listing of Purchase Orders. You can view the details by clicking on the PO No.</h5>
