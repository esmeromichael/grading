...
@section('content')
        ...
        <nav id="top_navigation" class="text_nav">
            <div class="container">
                <ul id="text_nav_h" class="clearfix j_menu top_text_nav jMenu">
                    <li><a href="/deskpad/partners/{{ $partnerinfo->id }}/profile">Profile</a></li>
 ...
 <table>
                    ...
                    <tr>
                            ...
                            <td>
                            <div class="col-xs-3">
                            <b><input type="text" id="inputCountry" name="country" class="form-control" value="{{$partnerinfo->country}}" placeholder="Country"  autofocus=""></b>Country
                            </div>
                            <div class="col-xs-3">
                    ...
                    <tr>
                            ...
                            <div class="col-xs-4">
                            Entity List
                            <b><select class="form-control" id="entity" name="business_entity" onchange="myFunction1()">
