...
<div class="modal fade" id="myModalsubsubject" role="dialog">
  <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content" >
            <div class="modal-header">
                <h4><b>New Sub Subject</b></h4>
            </div>
            <div class="modal-body">
            <h6>Create New Sub Subject Info</h6>
             <form class="form-horizontal"  name="bulkUnit" role="form"  method="POST" action="" >
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group">
                        <label class="col-md-3 control-label">Sub-Subject Name</label>
                    <div class="col-md-5">
