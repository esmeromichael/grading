...
$(document).ready(function(){
  if($('.status').val() == 'New') {
    ...
    $( ".quot_date" ).datepicker("option","disabled", false );
    $( ".date_needed" ).datepicker("option","disabled", false);
    //$('.display_terms').hide();
    // $('.add-terms2').show();
    // $(".showterms").show();
    //$(".showterms tr input:checkbox:not(:checked)").parent().parent().parent().hide();
    $('.add-header').show();
  ...
  else if($('.status').val() == 'Finalized') {
    $('.finalize').hide();
    $('.hide-terms').hide();
    $('.add-terms2').hide();
    $('.hidecustomer').hide();
    $('.hide_ordernavigator').hide();
    $('.hide_branch').hide();
    $('.hide_contactperson').hide();
    $('.add-header').hide();
    $('.add-terms').hide();
    $('.save').hide();
    $( ".validity" ).prop( "disabled", true );
    $( ".term" ).prop( "disabled", true );
    $( ".quot_type" ).prop( "disabled", true );
    $( ".fielddrag" ).prop( "disabled", true );
    $( ".ordpro" ).prop( "disabled", true );
    $( ".remarks" ).prop( "disabled", true );
    $( ".notes" ).prop( "disabled", true );
    $( ".quot_date" ).datepicker().datepicker("option","disabled", true);
    $( ".date_needed" ).datepicker("option","disabled", true );
    $(".showterms").hide();
    finalterms();
    $('.rm-header').hide();
    $('.btnDelete1').hide();
